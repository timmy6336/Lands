...
export function SkinsScreen({ auth, serverUrl, onBack, onShop, onProfileUpdated }: Props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      {equipMsg && (
        <div style={{ padding: '0.5rem', textAlign: 'center', color: 'var(--accent)', fontSize: '0.82rem', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
          {equipMsg}
        </div>
      )}

      <div style={{ flex: 1, overflowY: 'auto', padding: '1.25rem 1.5rem', display: 'flex', flexDirection: 'column', gap: 14, alignItems: 'center' }}>
